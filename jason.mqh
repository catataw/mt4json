...
{
public:
virtual void Clear() { m_parent=NULL; m_key=""; m_type=jtUNDEF; m_bv=false; m_iv=0; m_dv=0; m_prec=-1; m_sv=""; ArrayResize(m_e, 0); }
...
CJAVal(const double a, int aprec=-2) { Clear(); m_type=jtDBL; m_dv=a; if (aprec>=-1) m_prec=aprec; m_iv=(long)m_dv; m_sv=DoubleToString(m_dv, m_prec); m_bv=m_iv!=0; }
...
if (slen==0) return "";
#endif
char cc[]; ArrayCopy(cc, js, 0, i, slen); return CharArrayToString(cc, 0, WHOLE_ARRAY, CJAVal::code_page);
}
